...
{   
    switch(state)
    {
        case SYSTEM_STATE_USB_START:
            ...
            BUTTON_Enable(BUTTON_USB_DEVICE_HID_KEYBOARD_KEY_0);
            BUTTON_Enable(BUTTON_USB_DEVICE_HID_KEYBOARD_KEY_1);
            BUTTON_Enable(BUTTON_USB_DEVICE_HID_KEYBOARD_KEY_2);
            break;
